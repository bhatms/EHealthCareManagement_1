...
public class PatientQueryDaoImplTest1 implements BaseTest {

	final static Logger logger = Logger.getLogger(PatientQueryDaoImplTest1.class);
	...
	public void testpatientQuery() {
		try {
			List<PatientQuery> testPatientQueryList = patqueObj.patientQuery(Integer.valueOf("1"));
